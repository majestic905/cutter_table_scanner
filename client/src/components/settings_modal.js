    ...
    return (
        <form className="modal active" id="settings-modal" onSubmit={doSubmit}>
            ...
            <div className="modal-container modal-fullheight">
                ...
                <ul className="mt-0">
                   <li className="mt-0">
                       Значения table_sizes (миллиметры) напрямую в программе не используются, они здесь для того чтобы были.
                   </li>
                   <li className="mt-0">
                       Значения image_sizes (пиксели) используются; задаются, очевидно, вручную; должны быть строго пропорциональны значениям table_sizes!
                   </li>
               </ul>
